  ...
  return (
    <main className="min-h-[100dvh] bg-[#D6EFFB] flex flex-col relative overflow-hidden selection:bg-[#1D5FCC]/30">
      ...
      <header className="w-full px-6 py-6 flex justify-between items-center z-10 animate-fade-in">
        ...
        <Link href="/login" className="text-sm font-bold text-[#1D5FCC] hover:text-[#0E2A52] transition-colors px-4 py-2 rounded-full hover:bg-[#1D5FCC]/10">
          Iniciar sesión
        </Link>
      </header>
      ...
      <div className="flex-1 flex items-center justify-center p-5 z-10 pb-20">
        <div className="w-full max-w-[440px]">
          ...
          <p className="text-center text-[13px] text-[#4C6B8F]/80 mt-8 animate-fade-in" style={{ animationDelay: '700ms', animationFillMode: 'both' }}>
            Al registrarte aceptas nuestros{' '}
            <a href="#" className="font-semibold text-[#4C6B8F] hover:text-[#1D5FCC] underline underline-offset-2 transition-colors">Términos de servicio</a>
            {' '}y{' '}
            <a href="#" className="font-semibold text-[#4C6B8F] hover:text-[#1D5FCC] underline underline-offset-2 transition-colors">Política de privacidad</a>.
          </p>
        </div>
      </div>
