  ...
  return (
    ...
    >
      ...
      <div className="p-3 md:p-4 flex flex-col flex-grow">
        <h3 className="text-[13px] md:text-[14px] font-semibold text-gray-800 leading-snug mb-1 line-clamp-2 group-hover:text-[#1D5FCC] transition-colors">
          {producto.nombre}
        </h3>

        {storeName && (
          <p className="text-[11px] text-gray-400 mb-1 truncate">por {storeName}</p>
        )}
        ...
        {producto.descripcion && (
          <p className="text-[11px] text-gray-500 line-clamp-2 leading-relaxed mb-2 flex-grow">
            {producto.descripcion}
          </p>
        )}

        <div className="mt-auto pt-2 border-t border-gray-50">
          <p className="font-bold text-[18px] md:text-[20px] text-[#0E2A52] mb-2">
          ...
          {!unavailable ? (
            <a
              ...
              className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-[#25D366] hover:bg-[#1ebe5a] text-white font-semibold text-[13px] transition-all active:scale-95 shadow-sm"
            >
            ...
            <p className="text-center text-xs text-gray-400 py-2">No disponible</p>
          )}
        </div>
      </div>
    </article>
